...
const OmbudsmanForm = () => {
  ...
  const validationSchema = yup.object({
    ...
    email: yup
      .string()
      .email(t('ombudsman_form.email_is_invalid'))
      .required(t('ombudsman_form.form_required.email')),
    phone: yup.string(),
    subject: yup.string().required(t('ombudsman_form.form_required.subject')),
    message: yup.string().required(t('ombudsman_form.form_required.message')),
    recaptcha: yup
      .string()
      .required(t('ombudsman_form.form_required.recaptcha'))
  })
    ...
    <div>
      ...
      >
        <TextFieldCustom
          ...
          id="name"
          name="name"
          label={t('ombudsman_form.form_labels.name')}
        ...
        <TextFieldCustom
          ...
          id="email"
          name="email"
          label={t('ombudsman_form.form_labels.email')}
          className={clsx(classes.margin, classes.textField)}
          variant="filled"
          color="secondary"
        ...
        <TextFieldCustom
          ...
          id="phone"
          name="phone"
          label={t('ombudsman_form.form_labels.phone')}
          className={clsx(classes.margin, classes.textField)}
          variant="filled"
          color="secondary"
        ...
        <TextFieldCustom
          ...
          id="subject"
          name="subject"
          label={t('ombudsman_form.form_labels.subject')}
          className={clsx(classes.margin, classes.textField)}
          variant="filled"
          color="secondary"
        ...
        <TextFieldCustom
          ...
          id="message"
          name="message"
          label={t('ombudsman_form.form_labels.message')}
          className={clsx(classes.margin, classes.textField)}
          variant="filled"
          color="secondary"
          multiline
        ...
        <Box pt={2}>
          <ButtonColorWhite
            ...
            disableElevation
          >
            {t('ombudsman_form.form_labels.submit')}
          </ButtonColorWhite>
        </Box>
      </form>
          ...
          <>
            {isToSshowMessageSucess && (
              <Alert severity="success">
                {t('ombudsman_form.message_response.success')}
              </Alert>
            )}
            {!isToSshowMessageSucess && (
              <Alert severity="error">
                {' '}
                {t('ombudsman_form.message_response.fail')}
              </Alert>
            )}
          </>
        </Fade>
